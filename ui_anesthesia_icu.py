...
class AnesthesiaICUUI:
    def __init__(self, root, logic, module, gui):
        ...
        self.root.title("Anesthesia_ICU Module")
        ...
        title = tk.Label(
            self.scroll_frame,
            text="Anesthesia ICU Data Entry",
    ...
    def build_clinical_prompt(self, row):
        text = (
            "Aşağıdaki Anesthesia ICU verilerini klinik olarak değerlendir.\n"
